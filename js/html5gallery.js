...
(function() {
    ...
    if (u) {
        ...
        } : s.onload = function() { loadHtml5Gallery(v) };
...
function loadHtml5Gallery(u) {
    ...
    jQuery.extend(jQuery.easing, {
        ...
        easeInElastic: function(b, e, a, c, d) { b = 1.70158;
            var j = 0,
                f = c;
            if (0 == e) return a;
            if (1 == (e /= d)) return a + c;
        ...
        easeInBack: function(b, e, a, c, d, j) { void 0 == j && (j = 1.70158);
            return c * (e /= d) * e * ((j + 1) * e - j) + a },
        easeOutBack: function(b, e, a, c, d, j) { void 0 == j && (j = 1.70158);
            return c * ((e = e / d - 1) * e * ((j + 1) * e + j) + 1) + a },
        easeInOutBack: function(b, e, a, c, d, j) { void 0 == j && (j = 1.70158);
    ...
    v.fn.touchSwipe = function(b) {
        ...
        return this.each(function() {
            ...
            function b(a) { e.preventWebBrowser && a.preventDefault();
    ...
    var s = n.event,
        ...
        k = x.drag = {
            ...
            add: function(b) {
                ...
                n.each(k.defaults, function(b) { void 0 !== a[b] && (e[b] = a[b]) })
            },
            remove: function() { n.data(this, k.datakey).related -= 1 },
            setup: function() {
                if (!n.data(this, k.datakey)) {
                    var b = n.extend({ related: 0 }, k.defaults);
            ...
            init: function(b) {
                ...
                if (!(0 < e.which && b.which != e.which) && !n(b.target).is(e.not) && (!e.handle || n(b.target).closest(e.handle, b.currentTarget).length))
                    if (e.propagates = 1, e.interactions = [k.interaction(this, e)], e.target = b.target, e.pageX = b.pageX, e.pageY = b.pageY, e.dragging = null, a = k.hijack(b, "draginit", e), e.propagates) {
                        if ((a = k.flatten(a)) &&
                            a.length) e.interactions = [], n.each(a, function() { e.interactions.push(k.interaction(this, e)) });
            ...
            interaction: function(b, e) {
                return { drag: b, callback: new k.callback, droppable: [], offset: n(b)[e.relative ? "position" : "offset"]() || { top: 0, left: 0 } } },
            handler: function(b) {
                var e = b.data;
                switch (b.type) {
                    ...
                    case "mousemove":
                        if (e.dragging) { k.hijack(b, "drag", e);
                            if (e.propagates) {!1 !== e.drop && x.drop && x.drop.handler(b, e);
                                break }
                            b.type = "mouseup" }
                    case "mouseup":
            ...
            delegate: function(b) {
                ...
                return !e.length ? !1 : n(e).on("dragend." + k.livekey, function() { s.remove(this, "." + k.livekey) }) },
            ...
            textselect: function(b) { n(document)[b ? "unbind" : "bind"]("selectstart", k.dontstart).attr("unselectable", b ? "off" : "on").css("MozUserSelect", b ? "" : "none") },
            dontstart: function() {
                return !1 },
            callback: function() {}
        };
    k.callback.prototype = {
        update: function() {
            x.drop &&
                this.available.length && n.each(this.available, function(b) { x.drop.locate(this, b) })
        }
    };
    ...
    z.fn.html5boxTransition = function(b, e, a, c, d) {
        ...
        "fade" == l || "fadein" == l ? (a.hide(), e.insertBefore(a), a.fadeIn(f, j, function() { e.remove();
                d() })) :
            "fadeout" == l ? (a.show(), e.fadeOut(f, j, function() { e.remove();
                d() })) : "fadeinout" == l ? (a.hide(), e.insertBefore(a), e.fadeOut(f, j), a.fadeIn(f, j, function() { e.remove();
                d() })) : "crossfade" == l ? (a.hide(), e.fadeOut(f / 2, j, function() { a.fadeIn(f / 2, j, function() { e.remove();
                    d() }) })) : "slide" == l ? ($parent.css({ overflow: "hidden" }), h ? (a.css({ left: "100%" }), a.animate({ left: "0%" }, f, j), e.animate({ left: "-100%" }, f, j, function() { e.remove();
                d() })) : (a.css({ left: "-100%" }), a.animate({ left: "0%" }, f, j), e.animate({ left: "100%" }, f, j, function() {
                e.remove();
                d()
            }))) : (a.show(), e.remove(), d())
    };
    ...
    m.fn.addHTML5VideoControls = function(b, e, a) {
        ...
        k || (p.after(x), x.css({ position: "absolute", top: "50%", left: "50%", display: "block", cursor: "pointer", width: 64, height: 64, "margin-left": -32, "margin-top": -32, "background-image": "url('" + b + "html5boxplayer_playvideo.png')", "background-position": "center center", "background-repeat": "no-repeat" }).on("click", function() { p.get(0).play() }));
        ...
        p.after(w);
        p.after(z);
        z.css({ display: "none", position: "fixed", left: 0, top: 0, bottom: 0, right: 0, "z-index": 2147483647 });
        w.css({ display: "block", position: "absolute", width: "100%", height: h, left: 0, bottom: 0 });
        var D = function() { q = !0 };
        p.on("click", function() { q = !0 }).hover(function() { q = !0 }, function() { q = !1 });
        setInterval(function() { q && (w.show(), q = !1, clearTimeout(l), l = setTimeout(function() { p.get(0).paused || w.fadeOut() }, 5E3)) }, 250);
        ...
        m(".html5boxPlayPause", w).css({ display: "block", position: "relative", width: "32px", height: "32px", margin: Math.floor((h - 32) / 2), "float": "left" });
        var A = m(".html5boxPlay", w),
            I = m(".html5boxPause", w);
        A.css({ display: "block", position: "absolute", top: 0, left: 0, width: "32px", height: "32px", cursor: "pointer", "background-image": "url('" + b + "html5boxplayer_playpause.png')", "background-position": "top left" }).hover(function() { m(this).css({ "background-position": "bottom left" }) },
            function() { m(this).css({ "background-position": "top left" }) }).on("click", function() { p.get(0).play() });
        I.css({ display: "none", position: "absolute", top: 0, left: 0, width: "32px", height: "32px", cursor: "pointer", "background-image": "url('" + b + "html5boxplayer_playpause.png')", "background-position": "top right" }).hover(function() { m(this).css({ "background-position": "bottom right" }) }, function() { m(this).css({ "background-position": "top right" }) }).on("click", function() { p.get(0).pause() });
        ...
        B.css({ display: "block", position: "relative", "float": "left", "line-height": h + "px", "font-weight": "normal", "font-size": "12px", margin: "0 8px", "font-family": "Arial, Helvetica, sans-serif", color: "#fff" });
        O.css({
            display: "block",
            position: "relative",
            "float": "right",
        ...
        C.css({ display: "block", cursor: "pointer", overflow: "hidden", position: "relative", height: "10px", "background-color": "#222", margin: Math.floor((h - 10) / 2) + "px 4px" }).on(d, function(a) { a = (c ? a.originalEvent.touches[0] : a).pageX - C.offset().left;
            r.css({ width: a });
            p.get(0).currentTime = a * p.get(0).duration / C.width();
            C.on(j, function(a) { a = (c ? a.originalEvent.touches[0] : a).pageX - C.offset().left;
                r.css({ width: a });
                p.get(0).currentTime = a * p.get(0).duration / C.width() }) }).on(f, function() { C.off(j) });
        S.css({
            display: "block",
            position: "absolute",
            left: 0,
        ...
        if (!k && (p.get(0).requestFullscreen || p.get(0).webkitRequestFullScreen || p.get(0).mozRequestFullScreen || p.get(0).webkitEnterFullScreen || p.get(0).msRequestFullscreen)) {
            var E = function(a) {
                ...
                M.css({ "background-position": (a ? "right" : "left") + " " + b });
                z.css({ display: a ? "block" : "none" });
                a ? (m(document).on("mousemove", D), w.css({ "z-index": 2147483647 })) : (m(document).off("mousemove", D), w.css({ "z-index": "" }))
            };
            document.addEventListener("fullscreenchange", function() { t = document.fullscreen;
                E(document.fullscreen) }, !1);
            document.addEventListener("mozfullscreenchange", function() { t = document.mozFullScreen;
                E(document.mozFullScreen) }, !1);
            document.addEventListener("webkitfullscreenchange", function() {
                t = document.webkitIsFullScreen;
                E(document.webkitIsFullScreen)
            }, !1);
            p.get(0).addEventListener("webkitbeginfullscreen", function() { t = !0 }, !1);
            p.get(0).addEventListener("webkitendfullscreen", function() { t = !1 }, !1);
            ...
            M.css({
                ...
                m(this).css({ "background-position": a + " bottom" }) }, function() {
                var a = m(this).css("background-position") ? m(this).css("background-position").split(" ")[0] : m(this).css("background-position-x");
                m(this).css({ "background-position": a + " top" }) }).on("click", function() {
        ...
        if (s) m(".html5boxHD", w).css({ display: "block", position: "relative", "float": "right", width: "32px", height: "32px", margin: Math.floor((h - 32) / 2), cursor: "pointer", "background-image": "url('" + b + "html5boxplayer_hd.png')", "background-position": (n ? "right" : "left") + " center" }).on("click", function() {
            n = !n;
            m(this).css({ "background-position": (n ? "right" : "left") + " center" });
            e.isHd = n;
        ...
        if (p.get(0).volume === a / 2 + 0.1) {
            ...
            a.css({ display: "block", position: "relative", "float": "right", width: "32px", height: "32px", margin: Math.floor((h - 32) / 2) }).hover(function() { clearTimeout(g);
                var a = p.get(0).volume;
                L.css({ height: Math.round(100 * a) + "%" });
                F.show() }, function() {
                clearTimeout(g);
                g = setTimeout(function() { F.hide() }, 1E3)
            });
            K.css({ display: "block", position: "absolute", top: 0, left: 0, width: "32px", height: "32px", cursor: "pointer", "background-image": "url('" + b + "html5boxplayer_volume.png')", "background-position": "top left" }).hover(function() {
                var a = m(this).css("background-position") ? m(this).css("background-position").split(" ")[0] : m(this).css("background-position-x");
                m(this).css({ "background-position": a + " bottom" }) }, function() {
                var a = m(this).css("background-position") ? m(this).css("background-position").split(" ")[0] :
                    m(this).css("background-position-x");
                m(this).css({ "background-position": a + " top" })
            }).on("click", function() {
                var a = p.get(0).volume;
                ...
                K.css({ "background-position": (0 < a ? "left" : "right") + " " + b });
                p.get(0).volume = a;
                L.css({ height: Math.round(100 * a) + "%" }) });
            F.css({
                display: "none",
            ...
            y.css({ display: "block", position: "relative", width: 10, height: 68, margin: 7, cursor: "pointer", "background-color": "#222" });
            L.css({ display: "block", position: "absolute", bottom: 0, left: 0, width: "100%", height: "100%", "background-color": "#fcc500" });
            y.on(d, function(a) {
                ...
                p.get(0).volume = a;
                y.on(j, function(a) { a = 1 - ((c ? a.originalEvent.touches[0] : a).pageY - y.offset().top) / y.height();
                    a = 1 < a ? 1 : 0 > a ? 0 : a;
                    L.css({ height: Math.round(100 * a) + "%" });
                    K.css({ "background-position": "left " + (0 < a ? "top" : "bottom") });
                    p.get(0).volume = a })
            }).on(f, function() { y.off(j) })
        }
        var U = function(a) {
        ...
        f = function() {
            if (p.get(0).buffered && 0 < p.get(0).buffered.length && !isNaN(p.get(0).buffered.end(0)) && !isNaN(p.get(0).duration)) {
                var a = C.width();
                S.css({ width: Math.round(a * p.get(0).buffered.end(0) / p.get(0).duration) }) } };
        try {
            p.on("play", function() { x.hide();
                A.hide();
                I.show() }), p.on("pause", b), p.on("ended", b), p.on("timeupdate",
                d), p.on("progress", f)
        } catch (X) {}
    };
    var b = jQuery,
    ...
    b.fn.html5gallery = function(k) {
        var e = function(a, c, d) {
            ...
            try { new ActiveXObject("ShockwaveFlash.ShockwaveFlash") && (this.options.flashInstalled = !0) } catch (j) { navigator.mimeTypes["application/x-shockwave-flash"] && (this.options.flashInstalled = !0) }
        ...
        e.prototype = {
            ...
            createSocial: function(a) {
                ...
                if (this.options.showsocial) {
                    ...
                    a ? b(".html5gallery-fullscreen-box-" +
                        this.id, this.$fullscreen).append(d) : (b(".html5gallery-box-" + this.id, this.$gallery).append(d), "mouseover" == this.options.socialmode && b(".html5gallery-box-" + this.id).hover(function() { b(".html5gallery-social-" + c.id).fadeIn() }, function() { b(".html5gallery-social-" + c.id).fadeOut() }));
            ...
            initData: function(a) {
                ...
                if (this.options.src && 0 < this.options.src.length) {
                    ...
                    c = "https://gdata.youtube.com/feeds/api/videos?" + b.param(c), d = this, b.getJSON(c, function(b) {
                        ...
                        d.readTags();
                        a(d)
                    })) : this.options.youtubeapikey && this.options.youtubeplaylistid ? (d = this, this.getYouTubePlaylist(this.options.youtubeapikey, this.options.youtubeplaylistid, this.options.youtubeplaylistmaxresults, -1, function() { d.readTags();
                    a(d) }, this, null)) : (this.readTags(), a(this))
            },
            readTags: function() {
                var a = this;
                (b("img.html5galleryimg", this.container).length ? b("img.html5galleryimg", this.container) : b("img", this.container)).each(function() {
                    for (var c = b(this).attr("src"), d = a.options.lazyloadtags.split(","),
                            e = 0; e < d.length; e++)
                        if (b(this).data(d[e]) && 0 < b(this).data(d[e]).length) { c = b(this).data(d[e]);
                            break }
                    var d = c,
            ...
            processElemArray: function(a) {
                for (var b = !1, d = 0; d < a.elemArray.length; d++)
                    if (13 == a.elemArray[d][9] && a.elemArray[d][19] && a.elemArray[d][20]) { b = !0;
                        break }
            ...
            createSliderTimeout: function() {
                var a = this;
                a.slideshowTimeout = new HTML5GalleryTimer(a.options.slideshowinterval, function() { a.slideRun(-1) }, a.options.showtimer ? function(b) { a.updateTimer(b) } : null);
                a.options.pauseonmouseover && b(".html5gallery-elem-" + this.id, this.$gallery).hover(function() { a.isPaused || a.slideshowTimeout.pause() }, function() { a.isPaused || a.slideshowTimeout.resume(!1) }) },
            updateTimer: function(a) {
                this.isFullscreen ? (a = Math.max(0,
                    Math.floor(b(".html5gallery-fullscreen-elem-wrapper-" + this.id, this.$fullscreen).width() * a)), b(".html5gallery-fullscreen-timer-" + this.id, this.$fullscreen).css({ width: a + "px" })) : (a = Math.max(0, Math.floor(b(".html5gallery-elem-" + this.id, this.$gallery).width() * a)), b(".html5gallery-timer-" + this.id, this.$gallery).css({ width: a + "px" }))
            },
            createEvents: function() {
                var a = this;
                b(".html5gallery-play-" + this.id, this.$gallery).click(function() { a.playGallery() });
                b(".html5gallery-pause-" + this.id, this.$gallery).click(function() { a.pauseGallery() });
                b(".html5gallery-lightbox-" + this.id, this.$gallery).click(function() { a.goFullscreen() });
                b(".html5gallery-left-" + this.id, this.$gallery).click(function() { a.slideRun(-2, !0) });
                b(".html5gallery-right-" + this.id, this.$gallery).click(function() { a.slideRun(-1, !0) });
                if (a.options.enabletouchswipe) {
                    ...
                    b(".html5gallery-box-" + this.id, this.$gallery).touchSwipe({
                        preventWebBrowser: c,
                        swipeLeft: function() { a.disableTouchSwipe || a.slideRun(-1, !0) },
                        swipeRight: function() {
                            a.disableTouchSwipe ||
                                a.slideRun(-2, !0)
                        }
                ...
                if (!("ontouchstart" in window) || !a.options.disablehovereventontouch) b(".html5gallery-box-" + this.id, this.$gallery).mousemove(function() {
                    ...
                    if (a.options.titleoverlay && a.options.titleautohide && (!a.options.hidetitlewhenvideoisplaying || !a.isVideoPlaying)) b(".html5gallery-title-" + a.id, a.$gallery).show(), clearTimeout(a.hideTitleTimeout),
                        a.hideTitleTimeout = setTimeout(function() { b(".html5gallery-title-" + a.id, a.$gallery).fadeOut() }, 3E3)
                    ...
                    if (a.options.titleoverlay && a.options.titleautohide && (!a.options.hidetitlewhenvideoisplaying || !a.isVideoPlaying)) b(".html5gallery-title-" +
                        a.id, a.$gallery).fadeIn(), clearTimeout(a.hideTitleTimeout), a.hideTitleTimeout = setTimeout(function() { b(".html5gallery-title-" + a.id, a.$gallery).fadeOut() }, 3E3)
                }, function() { "mouseover" == a.options.imagetoolboxmode && a.hideimagetoolbox();
                ...
                b(".html5gallery-car-left-" + this.id, this.$gallery).click(function() { b(this).data("disabled") || (a.disableupdatecarousel = !0, a.updateCarouselTimeout = setTimeout(function() { a.enableUpdateCarousel() }, a.options.updatecarouselinterval), a.carouselPrev()) });
                b(".html5gallery-car-right-" + this.id, this.$gallery).click(function() {
                    b(this).data("disabled") ||
                        (a.disableupdatecarousel = !0, a.updateCarouselTimeout = setTimeout(function() { a.enableUpdateCarousel() }, a.options.updatecarouselinterval), a.carouselNext())
                });
                b(".html5gallery-car-slider-" + this.id, this.$gallery).on("drag", function(b, c) { a.disableupdatecarousel = !0;
                ...
                b(".html5gallery-car-slider-bar-" + this.id, this.$gallery).click(function(b) {
                    ...
                    a.updateCarouselTimeout =
                        setTimeout(function() { a.enableUpdateCarousel() }, a.options.updatecarouselinterval);
                ...
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        if (this.isFullscreen) {
                            ...
                            d = Math.min(e / c, d / a);
                            d = 1 < d ? 1 : d } else d = "fill" == this.options.resizemode ? Math.max(this.options.width / c, this.options.height /
                        ...
                        b(".html5gallery-elem-image-" + this.id).css({ width: e + "px", height: c + "px", top: h + "px", left: f + "px" })
                    } else if (5 ==
                    ...
                    this.options.showcarousel && (b(".html5gallery-car-" + this.id).css({
                        ...
                        (this.options.thumbShowNum - 1) * this.options.thumbgap, this.options.thumbTotalHeight = this.elemArray.length * this.options.thumbheight + (this.elemArray.length - 1) * this.options.thumbgap, this.options.carouselSlider && (this.options.carouselSliderMin = 0, this.options.carouselSliderMax = this.options.thumbMaskHeight - 54, b(".html5gallery-car-slider-bar-" + this.id).css({ height: this.options.thumbMaskHeight + "px" }), b(".html5gallery-car-slider-bar-middle-" + this.id).css({ height: String(this.options.thumbMaskHeight - 32) + "px" }),
                            ...
                            this.id).css({ top: a + "px", height: this.options.thumbMaskHeight + "px" }), this.carouselHighlight(this.curElem))
                }
            },
                ...
                this.options.showcarousel ? (d += " .html5gallery-car-" + this.id + " { position:absolute; display:block; overflow:hidden; width:" + this.options.carouselWidth + "px; height:" + this.options.carouselHeight + "px; left:" + this.options.carouselLeft + "px; top:" + this.options.carouselTop +
                    ...
                    3 * this.options.thumbmargin, this.options.thumbshowimage ? (c -= this.options.thumbimagewidth + 2 * this.options.thumbimageborder, a = this.options.thumbshowtitle ? this.options.thumbmargin : this.options.thumbwidth / 2 - (this.options.thumbimagewidth + 2 * this.options.thumbimageborder) / 2, e = Math.round((this.options.thumbheight - 2) / 2 - (this.options.thumbimageheight + 2 * this.options.thumbimageborder) / 2), d += " .html5gallery-tn-img-" + this.id + " {display:block; overflow:hidden; float:left; margin-top:" + e + "px; margin-left:" + a + "px; width:" +
                        ...
                        b(".html5gallery-car-slider-" +
                            this.id, this.$gallery).stop(!0).animate({ top: a }, 500)
            ...
            createImageToolbox: function() {
                ...
                if ("never" != this.options.showimagetoolbox) {
                    ...
                    b(".html5gallery-play-" + this.id, this.$gallery).hover(function() { b(this).css({ "background-position": "right top" }) }, function() { b(this).css({ "background-position": "left top" }) });
                    b(".html5gallery-pause-" + this.id, this.$gallery).hover(function() { b(this).css({ "background-position": "right top" }) }, function() { b(this).css({ "background-position": "left top" }) });
                    b(".html5gallery-left-" + this.id, this.$gallery).hover(function() { b(this).css({ "background-position": "right top" }) },
                        function() { b(this).css({ "background-position": "left top" }) });
                    b(".html5gallery-right-" + this.id, this.$gallery).hover(function() { b(this).css({ "background-position": "right top" }) }, function() { b(this).css({ "background-position": "left top" }) });
                    b(".html5gallery-lightbox-" + this.id, this.$gallery).hover(function() { b(this).css({ "background-position": "right top" }) }, function() { b(this).css({ "background-position": "left top" }) });
                ...
                this.showimagetoolbox =
                    function(a, c) {
                        if (this.options.showplaybutton || this.options.showprevbutton || this.options.shownextbutton || this.options.showfullscreenbutton) {
                            ...
                            d.hideToolboxTimeout = setTimeout(function() { d.hideimagetoolbox() }, 3E3);
                            if ("center" == this.options.imagetoolboxstyle) {
            ...
            resizeStyleDefault: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        b(".html5gallery-elem-image-" + this.id).css({ width: a + "px", height: e + "px", top: h + "px", left: f + "px" })
                    ...
                    b(".html5gallery-title-" + this.id).css({ width: d + "px" });
                    this.options.titleoverlay || b(".html5gallery-title-" +
                        this.id).css({ top: a + "px" });
                    ...
                    this.options.showcarousel && (b(".html5gallery-car-" + this.id).css({ width: this.options.width + "px", top: this.options.carouselTop + "px" }), b(".html5gallery-car-list-" + this.id).css({ width: String(this.options.width - 4 - 4) + "px" }), this.options.carouselNavButton = !1, Math.floor((this.options.width - 4 - 4) / (this.options.thumbwidth + this.options.thumbgap)) <
                        ...
                        this.options.thumbShowNum * this.options.thumbwidth + this.options.thumbShowNum * this.options.thumbgap, this.options.thumbTotalWidth = this.elemArray.length * this.options.thumbwidth + (this.elemArray.length - 1) * this.options.thumbgap, d = 0, this.options.carouselmultirows ? "samecolumn" == this.options.thumbresponsive ? (b(".html5gallery-thumbs-" + this.id).css({ "margin-left": "0px", width: String((this.options.thumbwidth + this.options.thumbgap) * this.options.carouselcolumn) + "px" }), b(".html5gallery-tn-" + this.id).css({
                                width: this.options.thumbwidth +
                                    "px",
            ...
            loadCarousel: function() {
                ...
                for (var d = 0; d < this.elemArray.length; d++) {
                    ...
                    e.hover(function() { a.onThumbOver(b(this).data("index"));
                        b(this).removeClass("html5gallery-tn-" + a.id).addClass("html5gallery-tn-selected-" + a.id) }, function() { b(this).data("index") !== a.curElem && b(this).removeClass("html5gallery-tn-selected-" + a.id).addClass("html5gallery-tn-" + a.id) });
                    e = new Image;
                    e.data = d;
                    b(e).on("load", function() {
                        ...
                        a.options.thumblinkintitle && b(".html5gallery-tn-img-" + a.id, c).off("click").click(function() { a.onThumbClick(b(this).parent().data("index"));
            ...
            goFullscreen: function() {
                ...
                }, function() { b(".html5gallery-fullscreen-next-" + g.id, g.$fullscreen).fadeOut();
                    b(".html5gallery-fullscreen-prev-" + g.id, g.$fullscreen).fadeOut() });
                b(".html5gallery-fullscreen-box-" + this.id, this.$fullscreen).touchSwipe({ preventWebBrowser: !0, swipeLeft: function() { g.disableTouchSwipe || g.slideRun(-1) }, swipeRight: function() { g.disableTouchSwipe || g.slideRun(-2) } });
                b(".html5gallery-fullscreen-close-" + this.id, this.$fullscreen).click(function() { g.goNormal() });
                b(".html5gallery-fullscreen-next-" +
                    this.id, this.$fullscreen).click(function() { g.slideRun(-1) });
                b(".html5gallery-fullscreen-prev-" + this.id, this.$fullscreen).click(function() { g.slideRun(-2) });
                ...
                b(".html5gallery-fullscreen-pause-" + this.id, this.$fullscreen).click(function() { b(".html5gallery-fullscreen-play-" + g.id, g.$fullscreen).show();
            ...
            enableUpdateCarousel: function() { this.disableupdatecarousel = !1 },
            slideRun: function(a, c, d, e) {
                ...
                if (this.options.showtitle || this.options.lightboxshowtitle || this.options.lightboxshowdescription) {
                    ...
                    if (this.isFullscreen) {
                        ...
                        b(".html5gallery-fullscreen-title-" + this.id, this.$fullscreen).html(h) } else this.options.showtitle &&
                ...
                if (!(0 > a)) {
                    ...
                    c.find("iframe").each(function() { b(this).attr("src", "") });
                    c.find("video").each(function() { b(this).attr("src", "") });
                    ...
                    if ((1 == a || this.showingPoster) && !this.isPaused && 1 < this.elemArray.length && (!this.options.loop || this.looptimes < this.options.loop)) this.slideshowTimeout.setInterval(this.elemArray[this.curElem][16] ? this.elemArray[this.curElem][16] : this.options.slideshowinterval), this.slideshowTimeout.start(), this.isFullscreen ? b(".html5gallery-fullscreen-timer-" +
                        this.id, this.$fullscreen).css({ width: 0 }) : b(".html5gallery-timer-" + this.id, this.$gallery).css({ width: 0 });
            ...
            showImage: function() {
                ...
                b(d).on("load", function() {
                    ...
                    if (c.isFullscreen) {
                        ...
                        d = 1 < d ? 1 : d } else d = "fill" == c.options.resizemode ? Math.max(c.options.width / this.width,
            ...
            adjustFullscreen: function(a, c, d) {
                ...
                d ? (b(".html5gallery-fullscreen-box-" + this.id, this.$fullscreen).css({ width: a + 2 * this.fullscreenMargin, height: c + 2 * this.fullscreenMargin + this.fullscreenBarH, top: f }), b(".html5gallery-fullscreen-elem-" + this.id, this.$fullscreen).css({ width: a + 2 * this.fullscreenMargin, height: c + 2 * this.fullscreenMargin }), b(".html5gallery-fullscreen-elem-wrapper-" +
                    ...
                    this.id, this.$fullscreen).animate({ width: a, height: c }, "slow"), b(".html5gallery-fullscreen-bar-" + this.id, this.$fullscreen).animate({ width: a + 2 * this.fullscreenMargin }, "slow"));
                ...
                b(".html5gallery-elem-video-container-" + this.id, this.$fullscreen).find("video").css({ width: a + "px", height: d + "px" });
                b("#html5gallery-elem-video-" + this.id, this.$fullscreen).css({ width: a + "px", height: c + "px" });
            ...
            showPoster: function() {
                ...
                b(h).on("load", function() {
                    ...
                    k = b(".html5gallery-elem-img-" +
                        d.id, c);
                    k.length ? (c.prepend(g), c.html5boxTransition(d.id, k, g, { effect: d.options.effect, easing: d.options.easing, duration: d.options.duration, direction: d.curElem >= d.savedElem, slide: d.options.slide }, function() {})) : c.html(g);
                    if (!b(".html5gallery-video-play-" + d.id, a).length) b("<div class='html5gallery-video-play-" + d.id + "' style='position:absolute;display:block;cursor:pointer;top:50%;left:50%;width:64px;height:64px;margin-left:-32px;margin-top:-32px;background:url(\"" + d.options.skinfolder + "playvideo_64.png\") no-repeat center center;'></div>").appendTo(c).off(d.eClick).on(d.eClick,
                        function() { d.options.hidetitlewhenvideoisplaying && b(".html5gallery-title-" + d.id, d.$gallery).hide();
                            b(this).remove();
            ...
            getFlashMovieObject: function(a) {
                ...
                if (-1 == navigator.appName.indexOf("Microsoft Internet")) {
                    if (document.embeds && document.embeds[a]) return document.embeds[a] } else return document.getElementById(a)
            },
            playVideo: function() {
            ...
            showVideo: function(a, c) {
                ...
                if (this.isFullscreen) {
                    ...
                    f = e;
                    e = h } else b(".html5gallery-elem-" + this.id, this.$gallery).css({
            ...
            showEmbedVideo: function(a) {
                ...
                if (this.isFullscreen) {
                    ...
                    e = d;
                    d = f } else b(".html5gallery-elem-" +
                    this.id, this.$gallery).css({ width: this.options.width, height: this.options.height }), e = this.options.width, d = this.options.height;
            ...
            showYoutube: function(a) {
                ...
                if (this.isFullscreen) {
                    ...
                    e = d;
                    d = f
                } else b(".html5gallery-elem-" + this.id, this.$gallery).css({ width: this.options.width, height: this.options.height }), e = this.options.width, d = this.options.height;
                f = this.elemArray[this.curElem][2];
                ...
                var h = this;
                if (!ASYouTubeIframeAPIReady && (ASYouTubeTimeout += 100, 3E3 > ASYouTubeTimeout)) { setTimeout(function() { h.showYoutube(a) }, 100);
                    return }
                if (ASYouTubeIframeAPIReady && !this.options.isMobile && !this.options.isIE6 && !this.options.isIE7) {
                    ...
                    f = null;
                    a && (f =
                        function(a) { a.target.playVideo() });
                    var l = this.getYoutubeParams(this.elemArray[this.curElem][2]),
                        l = b.extend({ html5: 1, controls: h.options.videohidecontrols ? "0" : "1", showinfo: h.options.videohidecontrols ? "0" : "1", autoplay: a ? 1 : 0, rel: 0, wmode: "transparent" }, l);
                    new YT.Player("html5gallery-elem-video-" + this.id, { width: e, height: d, videoId: c, playerVars: l, events: { onReady: f, onStateChange: function(a) { a.data == YT.PlayerState.ENDED && (h.onVideoEnd(), h.isPaused || h.slideRun(-1)) } } })
            ...
            showVimeo: function(a) {
                ...
                a && this.options.autoslideandplayafterfirstplayed && (this.options.autoplayvideo = !0, this.isPaused = !1);
                var c = this;
                if ("function" !== typeof $f && (ASVimeoTimeout += 100, 3E3 > ASVimeoTimeout)) { setTimeout(function() { c.showVimeo(a) }, 100);
                    return }
                var d = this.isFullscreen ? this.$fullscreen : this.$gallery,
                    e = this.elemArray[this.curElem][10],
                    f = this.elemArray[this.curElem][11];
                if (this.isFullscreen) {
                    ...
                    f = e;
                    e = h
                } else b(".html5gallery-elem-" + this.id, this.$gallery).css({ width: this.options.width, height: this.options.height }), f = this.options.width, e = this.options.height;
                ...
                if ("function" === typeof $f && a && !this.options.isAndroid) {
                    var d = b("#html5gallery_vimeo_" + this.id)[0],
                        l = $f(d),
                        c = this;
                    l.addEvent("ready", function() { l.addEvent("finish", function() { c.onVideoEnd();
            ...
            showIframe: function() {
                ...
                if (this.isFullscreen) {
                    ...
                    d = c;
                    c = e
                } else b(".html5gallery-elem-" + this.id, this.$gallery).css({ width: this.options.width, height: this.options.height }), d = this.options.width, c = this.options.height;
            ...
            embedHTML5Video: function(a,
                ...
                this.elemArray[this.curElem][5] && (b("video", a).css({ cursor: "pointer" }), b("video", a).off("click").on("click", function() { k.elemArray[k.curElem][5] && (k.elemArray[k.curElem][6] ? window.open(k.elemArray[k.curElem][5], k.elemArray[k.curElem][6]) : window.open(k.elemArray[k.curElem][5])) }));
                (h || g) && b("video", a).get(0).play();
                b("video", a).off("ended").on("ended", function() { k.onVideoEnd();
        ...
        this.each(function() {
            ...
            if ((!b(this).data("donotinit") || k && k.forceinit) && !b(this).data("inited")) {
                ...
                var d = this;
                b.each(a.data(), function(a, b) { d.options[a.toLowerCase()] = b });
...
function HTML5GalleryTimer(u, v, n) {
    ...
    var x = null,
        ...
        m = !1,
        b = !1;
    this.setInterval = function(b) { s.timeout = b };
    this.pause = function() { m && (z = !0, clearInterval(x)) };
    this.resume = function(u) {
        if (!b || u) b = !1, m && z && (z = !1, x = setInterval(function() { k += 50;
            k > s.timeout && (clearInterval(x), v && v());
            n && n(k / s.timeout) }, 50)) };
    this.stop = function() { clearInterval(x);
        n && n(-1);
        k = 0;
        m = z = !1 };
    this.start = function() {
        ...
        z = !1;
        m = !0;
        x = setInterval(function() { k += 50;
                k > s.timeout && (clearInterval(x), v && v());
                n && n(k / s.timeout) },
            50)
    };
    this.startandpause = function() { k = 0;
        b = m = z = !0 }
}
...
function HTML5GallerySWFObjectFunc() {
    ...
    function n(a) {
        if (typeof t.addEventListener != f) t.addEventListener("load", a, !1);
            ...
            N[N.length] = [b, "onload", a] } else if ("function" ==
            typeof t.onload) {
            var c = t.onload;
            t.onload = function() { c();
                a() } } else t.onload = a
    ...
    function z(a, c, d, h) {
        ...
        if (j) {
            ...
            r.ie && (r.win && 4 != j.readyState) && (h = q.createElement("div"), d += "SWFObjectNew", h.setAttribute("id", d), j.parentNode.insertBefore(h, j), j.style.display = "none", function() { 4 == j.readyState ? j.parentNode.removeChild(j) : setTimeout(arguments.callee, 10) }());
            D(a, c, d)
        }
    }
    ...
    function e(a) {
        var b = null;
        try { b = q.getElementById(a) } catch (c) {}
        return b }
                ...
                if (c) {
                    ...
                    (function() {
                        if (typeof c.GetVariable != f) {
                            ...
                            e && (e = e.split(" ")[1].split(","), r.pv = [parseInt(e[0], 10), parseInt(e[1], 10), parseInt(e[2], 10)]) } else if (10 > d) {
                            d++;
    ...
    if (typeof G.plugins != f && typeof G.plugins["Shockwave Flash"] ==
        h) {
        if ((y = G.plugins["Shockwave Flash"].description) && !(typeof G.mimeTypes != f && G.mimeTypes[l] && !G.mimeTypes[l].enabledPlugin)) V = !0, K = !1, y = y.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), F[0] = parseInt(y.replace(/^(.*)\..*$/, "$1"), 10), F[1] = parseInt(y.replace(/^.*\.(.*)\s.*$/, "$1"), 10), F[2] = /[a-zA-Z]/.test(y) ? parseInt(y.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0 } else if (typeof t.ActiveXObject != f) try {
    ...
    r = { w3: S, pv: F, wk: J, ie: K, win: M, mac: E };
    r.w3 && ((typeof q.readyState != f && "complete" == q.readyState || typeof q.readyState == f && (q.getElementsByTagName("body")[0] || q.body)) && u(), A || (typeof q.addEventListener != f && q.addEventListener("DOMContentLoaded", u, !1), r.ie && r.win && (q.attachEvent("onreadystatechange", function() { "complete" == q.readyState && (q.detachEvent("onreadystatechange", arguments.callee), u()) }), t == top && function() {
        if (!A) {
            try { q.documentElement.doScroll("left") } catch (a) {
    ...
    }()), r.wk && function() { A || (/loaded|complete/.test(q.readyState) ? u() : setTimeout(arguments.callee, 0)) }(), n(u)));
    ...
    return {
        ...
        switchOffAutoHideShow: function() { C = !1 },
        ua: r,
        ...
        showExpressInstall: function(a, b, c, d) { r.w3 && k() && z(a, b, c, d) },
        removeSWF: function(a) { r.w3 && T(a) },
        createCSS: function(a, b, d, e) { r.w3 && c(a, b, d, e) },
        addDomLoadEvent: v,
        addLoadEvent: n,
...
var html5GalleryObjects = new function() { this.objects = [];
    this.addObject = function(u) { this.objects.push(u) };
    this.loadNext = function(u) { this.objects[u].onVideoEnd();
        this.objects[u].isPaused || this.objects[u].slideRun(-1) };
    this.setHd = function(u, v, n) { this.objects[u].setHd(v, n) };
    this.gotoSlide = function(u, v) { "undefined" === typeof v && (v = 0);
        this.objects[v] && this.objects[v].slideRun(u) } };
if ("undefined" === typeof ASYouTubeIframeAPIReady) var ASYouTubeIframeAPIReady = !1,
    ASYouTubeTimeout = 0,
    onYouTubeIframeAPIReady = function() { ASYouTubeIframeAPIReady = !0 };
